...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Scheme.total'
        db.alter_column(u'data_scheme', 'total', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Scheme.total'
        raise RuntimeError("Cannot reverse this migration. 'Scheme.total' and its values cannot be restored.")

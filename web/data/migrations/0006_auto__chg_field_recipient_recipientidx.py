...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recipient.recipientidx'
        db.alter_column(u'data_recipient', 'recipientidx', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Recipient.recipientidx'
        raise RuntimeError("Cannot reverse this migration. 'Recipient.recipientidx' and its values cannot be restored.")

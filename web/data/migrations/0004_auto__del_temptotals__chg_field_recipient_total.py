...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'TempTotals'
        db.delete_table(u'data_temptotals')
    ...
    def backwards(self, orm):
        # Adding model 'TempTotals'
        db.create_table(u'data_temptotals', (
        ...
        db.send_create_signal(u'data', ['TempTotals'])
    ...
    models = {
        ...
        u'data.recipient': {
            ...
            'total': ('django.db.models.fields.FloatField', [], {'default': '0.0', 'db_index': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TotalYear.total'
        db.alter_column(u'data_totalyear', 'total', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Location.total'
        db.alter_column(u'data_location', 'total', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'RecipientYear.total'
        db.alter_column(u'data_recipientyear', 'total', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'SchemeYear.total'
        db.alter_column(u'data_schemeyear', 'total', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'RecipientSchemeYear.total'
        db.alter_column(u'data_recipientschemeyear', 'total', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Recipient.total'
        db.alter_column(u'data_recipient', 'total', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'TotalYear.total'
        db.alter_column(u'data_totalyear', 'total', self.gf('django.db.models.fields.FloatField')())

        # User chose to not deal with backwards NULL issues for 'Location.total'
        raise RuntimeError("Cannot reverse this migration. 'Location.total' and its values cannot be restored.")

        # Changing field 'RecipientYear.total'
        db.alter_column(u'data_recipientyear', 'total', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'SchemeYear.total'
        db.alter_column(u'data_schemeyear', 'total', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'RecipientSchemeYear.total'
        db.alter_column(u'data_recipientschemeyear', 'total', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Recipient.total'
        db.alter_column(u'data_recipient', 'total', self.gf('django.db.models.fields.FloatField')())

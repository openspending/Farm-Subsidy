...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'RecipientYear', fields ['total']
        db.create_index(u'data_recipientyear', ['total'])


    def backwards(self, orm):
        # Removing index on 'RecipientYear', fields ['total']
        db.delete_index(u'data_recipientyear', ['total'])
